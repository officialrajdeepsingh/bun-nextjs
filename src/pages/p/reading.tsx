      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="py-16 md:py-24 lg:py-32">
          <div className="mx-auto mb-12 flex flex-row items-start justify-around px-4 max-[991px]:flex-col md:mb-16 lg:mb-20 lg:items-start lg:justify-between">
            <div className="">
              <div className="mb-5">
                <a href="#" className="inline-block max-w-full text-[#797979] no-underline hover:outline-0">
                  <div className="">November 23, 2023</div>
                </a>
              </div>
            ...
            <div className="flex flex-col items-start justify-between max-[479px]:flex-col sm:items-start">
              ...
              <div className="flex items-center max-[479px]:mb-4 max-[479px]:flex-col max-[479px]:gap-y-4">
                <div className="mr-4">
                  <img src="https://assets.website-files.com/64fde6fd0e029101efaf5157/64ff390b0a44c933e6dcad7f_image1.jpeg" alt="" className="inline-block h-[3.875px] min-h-[56px] w-32 max-w-full rounded-[48px] object-cover" />
                </div>
                <div className="">
          ...
          <div className="relative mx-auto mb-12 w-full overflow-hidden lg:mb-20 pt-[50%] max-[991px]:pt-[56.25%]">
            <img alt="" src="https://assets.website-files.com/64fde6fd0e029101efaf5157/64fdf4f93714902ecf7eba93_Clear%20Communication.png" className="absolute inset-[0%] inline-block h-full w-full max-w-full object-cover" />
          </div>
